 ...
 *
 * Usage:
 *   npx get-policy-done                  # Interactive
 *   npx get-policy-done --local          # Install into current project
 *   npx get-policy-done --global         # Install globally
 *   npx get-policy-done --uninstall      # Remove
 */
...
const BRAND = {
  name: "get-policy-done",
  displayName: "Get Policy Done",
  prefix: "gpad",
  pyModule: "gpad",
  homeDir: ".gpad",
  homeDirEnv: "GPAD_HOME",
  description: "AI copilot for autonomous policy analysis and impact assessment",
  repo: "https://github.com/JesseRWeigel/get-policy-done",
};

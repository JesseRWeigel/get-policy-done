...
1. **Existence check**: Does the cited work exist? Verify against:
   - government databases (congress.gov, regulations.gov), SSRN, NBER, Google Scholar, and policy institute repositories
...
Load convention locks from .gpad/conventions.json.
...
Spawn gpad-referee with the manuscript. The referee runs 5 independent review perspectives:
...
#### 4f. Policy Relevance Review
- Is the policy recommendation actionable and specific?
- Are stakeholder impacts comprehensively analyzed?
- Is the political feasibility realistically assessed?
- Are implementation costs and timelines reasonable?

...
Run diagnostic checks on the GPAD project and optionally fix issues.

### Checks

1. **Required files**: .gpad/ directory exists, STATE.md, state.json, ROADMAP.md, config.json
...
- Initialize missing .gpad/ subdirectories

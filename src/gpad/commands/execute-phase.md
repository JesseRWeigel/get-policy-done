---
name: execute-phase
description: Execute the current phase — the main analysis loop
---
...
Read `{GPAD_INSTALL_DIR}/specs/workflows/execute-phase-workflow.md` first. Do NOT improvise.
...
### Pre-execution
1. Load state via gpad-state
2. Check conventions via gpad-conventions
...
2. For each plan/task in the wave (parallel):
   a. Spawn gpad-executor subagent with task context
...
1. Spawn gpad-verifier with all phase artifacts
